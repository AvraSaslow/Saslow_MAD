...
public class MainActivity extends AppCompatActivity  {
    ...
    Source for preserving state:
    https://medium.com/hootsuite-engineering/handling-orientation-changes-on-android-41a6b62cb43f
    https://developer.android.com/guide/components/activities/activity-lifecycle

    variables for saving landscape state
    private TextView mTextView;
    private static final String KEY_TEXT_VALUE = "landscape mode";
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*mTextView = (TextView) findViewById(R.id.vegetable_number);
    ...
    public void onSaveInstanceState(Bundle outState) {
        //outState.putCharSequence("GAME", gameState);
        //outState.putCharSequence("TEXTSTATEKEY", textView.getText());
